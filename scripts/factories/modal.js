export function modal(){
    ...
    <header class="modal-header">
        ...
        <img src="assets/icons/close.svg" onclick="closeModal()" aria-label="Fermer"  tabindex="2"/>
    ...
    <form class="modal-form">
            ...
            <div class="comment">
                ...
                <textarea  type="text" name="message" id="message" class="comment-message" tabindex="6"></textarea>
            </div>
